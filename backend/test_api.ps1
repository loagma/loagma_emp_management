...
$loginResponse = Invoke-WebRequest -Uri 'https://loagma-emp-management.onrender.com/auth/login/' -Method POST -Body $loginBody -ContentType 'application/json' -UseBasicParsing
...
$meResponse = Invoke-WebRequest -Uri 'https://loagma-emp-management.onrender.com/auth/me/' -Method GET -Headers $headers -UseBasicParsing
...
$statsResponse = Invoke-WebRequest -Uri 'https://loagma-emp-management.onrender.com/api/dashboard/stats/' -Method GET -Headers $headers -UseBasicParsing
Write-Host "   Response:" -ForegroundColor Green
...
$alertsResponse = Invoke-WebRequest -Uri 'https://loagma-emp-management.onrender.com/api/dashboard/alerts/' -Method GET -Headers $headers -UseBasicParsing
Write-Host "   Response:" -ForegroundColor Green
...
$tasksResponse = Invoke-WebRequest -Uri 'https://loagma-emp-management.onrender.com/api/tasks/' -Method GET -Headers $headers -UseBasicParsing
Write-Host "   Response:" -ForegroundColor Green
...
$employeesResponse = Invoke-WebRequest -Uri 'https://loagma-emp-management.onrender.com/api/employees/' -Method GET -Headers $headers -UseBasicParsing
Write-Host "   Response:" -ForegroundColor Green
...
$analyticsResponse = Invoke-WebRequest -Uri 'https://loagma-emp-management.onrender.com/api/analytics/summary/' -Method GET -Headers $headers -UseBasicParsing
Write-Host "   Response:" -ForegroundColor Green
...
$trendsResponse = Invoke-WebRequest -Uri 'https://loagma-emp-management.onrender.com/api/analytics/trends/?period=7d' -Method GET -Headers $headers -UseBasicParsing
Write-Host "   Response:" -ForegroundColor Green
